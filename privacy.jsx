...
export default function Privacy(){
    return (
        ...
        <div className={`
            ...
            <h1>Agradecemos por usar o app ARota<br/>
            ...
            <div>
                ...
                1.4. Regulamentação. O A Rota e a Plataforma atuam de acordo com a legislação brasileira, atendendo, inclusive e especialmente, os termos da Lei nº. 12.965/2014, o Marco Civil da Internet, bem como a Lei nº 13.709/18, a Lei Geral de Proteção de Dados Pessoais ou LGPD, e vincula-se, desde logo, às demais leis que venham a ser aplicadas.<br/>
                1.5. Dúvidas. Em caso de dúvida sobre a Política de Privacidade ou Termos de Uso da plataforma ARota, você poderá entrar em contato com os administradores pelo e-mail devalves2020@gmail.com., além de por meio de formulários de contato dentro da próprio Site.<br/>
            ...
            <div>
                ...
                2.1. Coleta de Dados Pessoais.<br/>
                    ...
                    c) DETALHES RELACIONADOS ÀS VISITAS À PLATAFORMA AROTA E AOS RECURSOS QUE VOCÊ UTILIZAR;<br/>
                    d) INFORMAÇÕES DE REGISTRO DO SERVIDOR, QUE PODEM INCLUIR INFORMAÇÕES COMO ENDEREÇO IP DO DISPOSITIVO, ACESSO A DATAS E HORÁRIOS, CARACTERÍSTICAS DA PLATAFORMA AROTA OU PÁGINAS VISUALIZADAS, E OUTRAS ATIVIDADES DO SISTEMA, SISTEMA OPERACIONAL, TIPO DE NAVEGADOR E SITES DE TERCEIROS OU SERVIÇO UTILIZADO ANTES DE INTERAGIR COM OS NOSSOS SERVIÇOS;<br/>
            ...
            <div>
                ...
                <h3>
                3.1. Utilização.
                    O app AROTA PODE UTILIZAR OS DADOS PESSOAIS COLETADOS NA PLATAFORMA, DESCRITAS ACIMA, PARA:<br/>
                    ...
                    g) CONTATAR E NOTIFICAR O USUÁRIO ACERCA DE MODIFICAÇÕES NA PLATAFORMA, EM SEUS PRAZOS, SERVIÇOS OFERECIDOS PELO AROTA OU EM SUAS POLÍTICAS E TERMOS DE USO, QUANDO NECESSÁRIO;<br/>
                    ...
                    j) CASO VOCÊ SEJA UM VISITANTE PARA OFERTAR OS PRODUTOS E SERVIÇOS DO AROTA ATRAVÉS DE CONTATOS VIA E-MAIL, TELEFONE OU WHATSAPP;<br/>
                ...
                3.3. Registros. O AROTA MANTÉM OS REGISTROS DE ACESSO A APLICAÇÕES DE INTERNET, SOB SIGILO, EM AMBIENTE CONTROLADO E DE SEGURANÇA, UTILIZANDO-SE DE CRIPTOGRAFIAS COM CERTIFICADO SSL PARA TAL, PELO PRAZO DE 6 (SEIS) MESES, NOS TERMOS DO ARTIGO 15, DO MARCO CIVIL DA INTERNET.<br/>
                3.4. Retenção e Exclusão de Dados Pessoais. O AROTA garante a proteção dos dados pessoais a partir do momento que os usuários fornecem seus dados para o AROTA, seja para viabilizar a contratação de um produto e/ou serviço, ou para receber comunicados, convites, informativos, bem como para melhorar e otimizar sua experiência de navegação no website. Caso opte em algum momento pela exclusão de seus dados pessoais do banco de armazenamento, o AROTA poderá reter algumas informações pessoais por um período adicional para fins de cumprimento de obrigações legais ou regulatórias, assim como para eventual exercício regular de direito do AROTA, bem como para fins de auditorias e cumprimento de normas de compliance. A retenção dos dados pessoais será feita durante o prazo necessário ao cumprimento das sobreditas obrigações, sempre respeitando os prazos estabelecidos na legislação aplicável.<br/>
                </h3>    
            </div>
            <div>
                ...
                O AROTA NÃO DIVULGA JUNTO A TERCEIROS QUALQUER DADO PESSOAL FORNECIDO PELO USUÁRIO ATRAVÉS DA PLATAFORMA, EXCETO:<br/>
                a) NOS CASOS EM QUE O AROTA FOR OBRIGADO A DIVULGAR OU PARTILHAR OS DADOS COLETADOS A FIM DE CUMPRIR QUALQUER OBRIGAÇÃO LEGAL (COMO EM VIRTUDE DE ORDEM JUDICIAL), OU PARA EFEITOS DE PREVENÇÃO DE FRAUDE OU OUTROS CRIMES, BEM COMO EM RESPOSTA À SOLICITAÇÃO DE INFORMAÇÕES APRESENTADA POR AUTORIDADE COMPETENTE, SE ENTENDERMOS QUE A DIVULGAÇÃO ESTÁ DE ACORDO OU É EXIGIDA CONFORME AS LEIS, REGULAMENTOS OU PROCEDIMENTOS PROCESSUAIS APLICÁVEIS;<br/>
                b) PARA FAZER CUMPRIR QUAISQUER CONDIÇÕES DE UTILIZAÇÃO APLICÁVEIS AO AROTA, OU PARA FAZER CUMPRIR OS TERMOS DE USO REFERENTES AOS SERVIÇOS QUE POSSAM SER APLICÁVEIS;<br/>
                c) PARA PROTEGER OS DIREITOS, BENS OU A SEGURANÇA DO AROTA E DA PLATAFORMA;<br/>
                d) O AROTA PODE COMPARTILHAR DADOS PESSOAIS COM FORNECEDORES, CONSULTORES, PARCEIROS DE MARKETING, PRESTADORES DE SERVIÇOS DE BUSINESS INTELLIGENCE E DATA ANALYTICS E OUTROS PRESTADORES DE SERVIÇOS QUE PRECISEM ACESSAR AS INFORMAÇÕES PARA EXECUÇÃO DO TRABALHO EM NOSSO NOME, ESTANDO ESTES SUJEITOS A SEGUIR AS MESMAS REGRAS DISPOSTAS NESTA POLÍTICA;<br/>
                e) O AROTA PODE COMPARTILHAR INFORMAÇÕES COM AGENTES DA LEI, AUTORIDADES GOVERNAMENTAIS OU TERCEIROS, SE ENTENDERMOS QUE SUAS AÇÕES SÃO INCONSISTENTES EM RELAÇÃO ÀS DISPOSIÇÕES EM NOSSOS TERMOS DE USO, OU PARA PROTEGER OS DIREITOS, A PROPRIEDADE OU A SEGURANÇA DO AROTA OU DE OUTROS;<br/>
                ...
                4.2. Não Divulgação de Dados Pessoais de Usuários. Com exceção das situações acima descritas, o AROTA não divulgará qualquer dado pessoal do USUÁRIO, exceto se devidamente autorizado por este ou mediante ação do próprio USUÁRIO, como o envio de dados pessoais gerais por e-mail ou publicações em alguma rede social, mediante autorização do USUÁRIO.<br/>
                4.3. Dados Pessoais Adicionais. OS DADOS PESSOAIS ADICIONAIS COLETADOS PELO AROTA ATRAVÉS DA ANÁLISE DA NAVEGAÇÃO DE CADA USUÁRIO E QUE NÃO O TORNE IDENTIFICÁVEL PESSOALMENTE (COMO O PADRÃO DE NAVEGAÇÃO, POR EXEMPLO) SÃO DE PROPRIEDADE EXCLUSIVA DO AROTA, A QUAL PODE USAR ESSAS INFORMAÇÕES DO MODO QUE MELHOR JULGAR APROPRIADO.<br/>
                4.4. Direito de Não Aceitação. O USUÁRIO TEM O DIREITO DE NÃO ACEITAR OS PRESENTES TERMOS DA POLÍTICA E PROCEDER COM A NÃO INSERÇÃO OU COM A REMOÇÃO DE SEUS DADOS DA PLATAFORMA. PORÉM, EM CASO DE REMOÇÃO, ESTÁ NÃO TERÁ EFEITOS RETROATIVOS, DE MODO QUE AS AÇÕES ANTERIORES À ESSA REMOÇÃO CONTINUARÃO ARMAZENADOS E COM USO DE ACORDO COM OS INTERESSES DO AROTA, RESPEITANDO A LEGISLAÇÃO APLICÁVEL.<br/>
            ...
            <div>
                ...
                <h3>
                5.1. O que são os Cookies. Um cookie é um trecho de informação armazenado localmente no computador ou dispositivo do USUÁRIO, e que contém informação acerca das atividades deste na Internet. Essas informações de cookies não contêm qualquer informação pessoal identificável, como as que o USUÁRIO envia para a plataforma AROTA.<br/>
                5.2. Cookies Utilizados. Os cookies podem ser usados de diferentes formas e modalidades. Aqui, no AROTA, poderão ser utilizados os seguintes, listados abaixo:<br/>
                a) Cookies Funcionais: Estes cookies são usados pela plataforma AROTA por algumas de suas funcionalidades, buscando oferecer uma melhor experiência ao navegar pela plataforma. Como por exemplo, mas não se limitando a este, cookie que permite saber se você escolheu a opção “Mantenha-me conectado” para que o site entre automaticamente na conta da próxima vez que voltar à página;<br/>
                b) Cookies de Desempenho: Este tipo de cookie coleta informações anônimas sobre a forma como o USUÁRIO utiliza o AROTA, para podermos otimizá-la. As informações coletadas por estes cookies nunca contêm detalhes pessoais a partir dos quais seja possível identificá-lo; e<br/>
                ...
                5.4. Consentimento para Utilização de Cookies. A plataforma AROTA é obrigada a obter o seu consentimento antes de usar cookies. Se continuar a navegar na Plataforma depois de ter aceitado esta Política de Privacidade, então assumimos que você concorda com a utilização de cookies nos termos acima descritos.<br/>
            ...
            <div>
                ...
                O AROTA reserva aos respectivos usuários a possibilidade de exercerem os direitos previstos na LGPD, podendo apresentar solicitações relacionadas aos seus dados pessoais, tais como:<br/>
            ...
            <div>
                ...
                8.3. Ajustes Não Notificados. Pequenos ajustes nesta Política de Privacidade podem ocorrer sem afetar significativamente as formas em que o AROTA trata as informações coletadas, de forma que estes não precisarão ser informados.<br/>
                </h3>
            </div>
            <div>
                <h2>CAPÍTULO IX – USO DO E-MAIL</h2>
                <h3>
                9.1. Envio de Comunicações. O USUÁRIO, ao se cadastrar, concorda que o AROTA envie para o seu e-mail fornecido notificações e comunicações, novidades sobre os serviços ou informações importantes que necessitem de sua atenção, além de material publicitário sobre novos serviços da Plataforma e também de seus parceiros.<br/>
                9.1.1. Opção por Não Recebimento. Quando o USUÁRIO receber um e-mail do AROTA, em nome da plataforma AROTA, haverá a possibilidade de optar por não mais recebe-los, bem como poderá solicitar o não recebimento enviando uma mensagem através do e-mail devalves2020@gmail.com, pedindo a exclusão do seu endereço da lista de envio.<br/>
                ...
                9.1.3. Política AntiSpam. O AROTA toma os cuidados necessários para evitar o envio não solicitado de e-mails aos USUÁRIOS. Por isso fica estabelecido que é absolutamente proibida a utilização da ferramenta "Envie este link a um amigo", com a finalidade de Spam, ou envio indiscriminado de mensagens de qualquer natureza via correio eletrônico, por parte da Plataforma ou do AROTA.<br/>
            ...
            <div>
                ...
                <h3>
                10.1. Remoção. O AROTA se reserva o direito de negar ou remover qualquer conexão que contenha informações incorretas ou apelos não substanciados, ou que estejam em conflito com a missão, política e finalidade da empresa ou da Plataforma.<br/>
                </h3>
            </div>
            <div>
                ...
                11.2. Se o AROTA tomar conhecimento de qualquer violação à segurança própria ou a empresas de hospedagem, incluindo qualquer hacker ou outro “break-in”, iremos notificá-lo imediatamente de tal violação e fornecer o máximo de detalhes que possuirmos referente à natureza e extensão da violação e os dados comprometidos.<br/>
                11.3. Permissões. O AROTA, e qualquer pessoa designada pela mesma, pode copiar, divulgar, distribuir, incorporar e de outra forma utilizar o material e todos os dados, imagens, sons, texto e outras informações incorporadas a ele para todos e quaisquer fins, sejam eles comerciais ou não, desde que respeitados os termos desta Política e a legislação vigente.<br/>
                11.4. Responsabilidade do Usuário. O USUÁRIO será responsável por indenizar o AROTA por todos os custos e danos que este possa incorrer, como resultado da violação desta Política ou dos Termos de Uso da Plataforma.<br/>
                11.5. Cooperação. O AROTA coopera plenamente com quaisquer autoridades ou tribunais que venham a solicitar a divulgação da identidade ou localização de qualquer pessoa que tenha inserido qualquer material na Plataforma que violem as Cláusulas dispostas nesta Política.<br/>
                11.6. Limitação de Responsabilidade. Esta Política de Privacidade aborda apenas o uso e divulgação de dados pessoais coletados pela Plataforma. Se você divulgar seus dados pessoais a terceiros em redes abertas ou através de sites em toda a internet, regras diferentes podem ser aplicadas à sua utilização ou divulgação das informações. O AROTA não controla as políticas de privacidade de terceiros, às quais você possa estar sujeito. Encorajamos nossos USUÁRIOS a se informarem sobre as Políticas de Privacidade antes de divulgar suas informações pessoais a terceiros. O AROTA não aceitará qualquer responsabilidade por perdas, diretas ou indiretas, devido à segurança de seus dados pessoais durante sua transferência via internet.<br/>
                </h3>
            </div>
            <div>
                <h2>CAPÍTULO XII – CONTATO</h2>
                <h3>
                12.1. Contato. O USUÁRIO pode entrar em contato com o AROTA em qualquer momento e compartilhar suas opiniões sobre as práticas de privacidade ou sobre qualquer questão relacionada às suas informações pessoais. Para isso basta entrar em contato através do e-mail devlaves2020@gmail.com, além de por meio de formulários de contato dentro da própria Plataforma.<br/>
                </h3>
            </div>
          </div>
       </Layout>
